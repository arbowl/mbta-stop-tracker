...
class Ui_mbta_tracker_window(object):
    ...
    def retranslateUi(self, mbta_tracker_window):
        ...
        self.ride_1_box_1.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
        self.ride_1_box_2.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
        self.ride_2.setTitle(_translate("mbta_tracker_window", "Ride 2: "))
        self.ride_2_box_2.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
        self.ride_2_box_1.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
        self.ride_3.setTitle(_translate("mbta_tracker_window", "Ride 3: "))
        self.ride_3_box_2.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
        self.ride_3_box_1.setPlainText(_translate("mbta_tracker_window", " 16 minutes"))
