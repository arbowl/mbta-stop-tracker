...
class Ui_mbta_tracker_window(object):
    def setupUi(self, mbta_tracker_window):
        ...
        self.direction_label.setGeometry(QtCore.QRect(610, 32, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Source Serif Pro Black")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.method_label.setGeometry(QtCore.QRect(900, 40, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Source Serif Pro Black")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.label.setGeometry(QtCore.QRect(890, 110, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Source Serif Pro Black")
        font.setPointSize(8)
        font.setBold(True)
    ...
    def retranslateUi(self, mbta_tracker_window):
        ...
        self.label.setText(_translate("mbta_tracker_window", "For stops at the start of a route, use \"Schedules\""))
